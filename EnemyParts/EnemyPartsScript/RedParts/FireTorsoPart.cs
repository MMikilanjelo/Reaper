...
namespace Enemy.Parts
{
    ...
    public partial class FireTorsoPart : TorsoPart
    {
        public FireTorsoPart(float decresmentDmgProcent, PartsCounter partsCounter  , string PathToArt) : base(decresmentDmgProcent, partsCounter)
        {
